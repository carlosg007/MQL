/**
 * Robot Factory Expert Advisor
 *
 * Exported from Forex Robot Factory | Expert Advisor Generator
...
static input int    Magic_Number = 1098486920; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =      246; // Stop Loss   (pips)
       input int    Take_Profit  =      923; // Take Profit (pips)

static input string ___0______   = "------"; // --- Bulls Power ---
       input int    Ind0Param0   =        6; // Period
...
static input string ___2______   = "------"; // --- Bears Power ---
       input int    Ind2Param0   =       21; // Period
       input double Ind2Param1   =  27.2000; // Level
...
string robotTagline  = "An Expert Advisor from Forex Robot Factory | Expert Advisor Generator";
...
int GetEntrySignal(void)
  {
   ...
   double ind0val1  = iBullsPower(NULL, 0, Ind0Param0, PRICE_CLOSE, 1);
   double ind0val2  = iBullsPower(NULL, 0, Ind0Param0, PRICE_CLOSE, 2);
...
void ManageClose(void)
  {
   // Bears Power (21), Level: 27.2000
   double ind2val1  = iBearsPower(NULL, 0, Ind2Param0, PRICE_CLOSE, 1);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET AAFX-Demo; XAUUSD; H4 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":246,"takeProfit":923,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[6,0,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[3,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Bears Power","listIndexes":[2,0,0,0,0],"numValues":[21,27.2,0,0,0,0]}]} */
